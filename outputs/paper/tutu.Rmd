---
title: "STA304A3^[Code and data are available at https://github.com/YN7666/sta-304-a3]"
author: "vincent"
date: "02/22/2022"
output: pdf_document
---
...
ggplot(t_mp4, aes(x=total_children, y = feeling_of_life, group = feeling_of_different_sex, colour = feeling_of_different_sex)) +
  geom_line() +
  theme_classic() + scale_x_continuous(breaks = a)+ 
  labs( title="fig.6: Total children relevant to feelings_life")
```
...
group <- work_last_data %>%group_by(worked_last_week) %>% summarise(n=n())
 ggplot(work_last_data, aes(x= feelings_life, fill = worked_last_week)) +
  geom_bar() +
  labs(title= "fig.8: different feelings_life group") +
   theme_classic()
```
...
\newpage
fig.10:screenshot of survey 1-4 _____________ fig.11:screenshot of survey 4-7\
![](WeChat Screenshot_20220320142338.png){#id .class width=50% }
![](WeChat Screenshot_20220320142402.png){#id .class width=50% height=120%}\
\newpage
fig.12:screenshot of survey 8-10 _____________ fig.13:screenshot of survey 11-13\
