...
Figure 2 shows all six interested groups that may affect the distribution of feelings about life. Panel A is called the "different income_respondent group" and it represents the total income before tax of the respondent of the family. There are 6 groups including here as a scale from the lowest one, “Less than $25,000” to the highest one “$125,000 and more”. The most common category of panel A is $25,000 to $49,999 and the least common category is $100,000 to $ 124,999. Combined with table.2 we can conclude that, it is approximately 5 times more common in the highest category than the lowest one. Therefore, it is rational to say that most Canadians earn under $100,000 per year.
